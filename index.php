    ...
    <div class="container">
        <header>
            ...
            <nav>
                <ul>
                    <li><a href="/">Home</a></li>
                    <li><a href="/posts/index.php">Blogs</a></li>
                </ul>
            </nav>
        </header>
        <div class="intro">
        ...
        <div class="blogs" id="blogs">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '<br>';
                    echo '<a class="button-padding-right" href="edit.php?id=' . $row["id"] . '">Edit</a>';
                    echo '<a class="button-padding" href="delete.php?id=' . $row["id"] . '">Delete</a>';
                    echo '</div>';
                }
            } else {
